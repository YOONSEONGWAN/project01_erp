...
<%
    ...
    if (hasFilter) {
        ...
        totalRows = dao.getWeeklyMaxCountBetween("2000-01-01", "2099-12-31");
        list = dao.getWeeklyMaxSalesDates("2000-01-01", "2099-12-31", startRow, endRow);
    }
...
<nav>
    <ul class="pagination justify-content-center">
        ...
        <li class="page-item <%= i == pageNum ? "active" : "" %>">
            <a class="page-link"
               href="<%= request.getContextPath() %>/headquater.jsp?page=headquater/sales.jsp<%= start != null ? "&start=" + start : "" %><%= end != null ? "&end=" + end : "" %>&view=weekly-max&pageNum=<%= i %>">
                <%= i %>
            </a>
        </li>
        <% } %>
