...
<%
	...
	int totalRows = dao.getMonthlyRankStatsCountBetween(startSafe, endSafe);
	List<SalesDto> list = dao.getMonthlyRankStatsPageBetween(startSafe, endSafe, startRow, endRow);
	
	int totalPages = Math.max(1, (int) Math.ceil(totalRows / (double) pageSize));
	NumberFormat nf = NumberFormat.getInstance();
	
	String base  = request.getContextPath() + "/headquater.jsp?page=headquater/sales.jsp&view=monthly-rank";
