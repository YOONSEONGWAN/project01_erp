...
<%
	...
	int totalRows = dao.getWeeklyAvgCountBetween(startSafe, endSafe);
	List<SalesDto> list = dao.getWeekyAvgPageBetween(startSafe, endSafe, startRow, endRow);
	
	int totalPages = Math.max(1, (int)Math.ceil(totalRows / (double)pageSize));
	NumberFormat nf = NumberFormat.getInstance();
	
	String base  = request.getContextPath() + "/headquater.jsp?page=headquater/sales.jsp&view=weekly-avg";
