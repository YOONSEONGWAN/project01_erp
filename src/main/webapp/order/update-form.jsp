...
<h3>발주 요청 수정</h3>
<form action="<%=request.getContextPath()%>/headquater.jsp?page=order/update-request.jsp" method="post">
    ...
    <table>
     ...
     <div style="text-align:right; margin-top:18px;">
        ...
        <a href="<%=request.getContextPath()%>/headquater.jsp?page=order/list.jsp" class="btn btn-secondary">목록으로</a>
    </div>
</form>
</body>
</html>