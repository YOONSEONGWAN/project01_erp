...
<div class="container py-5">
    ...
    <div class="d-flex flex-column justify-content-center" style="min-height: calc(100vh - 150px);">
        ...
        <div class="d-flex justify-content-end mb-3">
		    <form class="d-flex" method="get" action="${pageContext.request.contextPath}/headquater.jsp" style="gap: 5px;">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination justify-content-center">
                <% if (currentPage > 1) { %>
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/headquater.jsp?page=/stock/inbound_list.jsp?page=<%= currentPage - 1 %>&managerKeyword=<%= managerKeyword %>">이전</a>
                    </li>
                <% } else { %>
                ...
                <% for (int i = 1; i <= totalPages; i++) {
                    ...
                    <% } else { %>
                        <li class="page-item">
                            <a class="page-link" href="${pageContext.request.contextPath}/headquater.jsp?page=/stock/inbound_list.jsp?page=<%= i %>&managerKeyword=<%= managerKeyword %>"><%= i %></a>
                        </li>
                <% }} %>

                <% if (currentPage < totalPages) { %>
                    <li class="page-item">
                        <a class="page-link" href="${pageContext.request.contextPath}/headquater.jsp?page=/stock/inbound_list.jsp?page=<%= currentPage + 1 %>&managerKeyword=<%= managerKeyword %>">다음</a>
                    </li>
                <% } else { %>
