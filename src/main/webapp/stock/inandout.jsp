...
<%
	...
	int latestOrderId = list.get(0).getOrderId(); // list가 비어있지 않다고 가정
        ...
        <h2>입출고 종합 목록</h2>
    		...
    		<tbody>
        		...
        		<tr>
            		...
            		<td><%= dto.getInApproval() %></td>
            		<td><%= dto.getIn_date() %></td>
           			<td><%= dto.isOutOrder() ? "YES" : "NO" %></td>
            		<td><%= dto.getOutApproval() %></td>
            		<td><%= dto.getOut_date() %></td>
