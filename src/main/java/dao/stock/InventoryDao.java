...
public class InventoryDao {
	...
	public boolean increaseQuantity(int num, int amount) {
		...
		try (Connection conn = new DbcpBean().getConn(); PreparedStatement pstmt = conn.prepareStatement(sql)) {
	...
	public boolean updateQuantityByApproval(int num, int oldRequestQty, int newRequestQty, String oldApprovalStatus,
			String newApprovalStatus, int currentQuantity) {
		Connection conn = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
